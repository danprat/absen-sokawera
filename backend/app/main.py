...
Path(settings_config.FACE_UPLOAD_ROOT).mkdir(parents=True, exist_ok=True)
app.mount(
    settings_config.FACE_UPLOAD_PUBLIC_PREFIX,
    StaticFiles(directory=settings_config.FACE_UPLOAD_ROOT),
    name="uploads",
)
